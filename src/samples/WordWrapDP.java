...
public class WordWrapDP {
    ...
    public static void main(String args[]){
        ...
        WordWrapDP awl = new WordWrapDP();
        System.out.println(awl.justify(words1, 10));

        String words2[] = {"aaa","bb","cc","ddddd"};
        System.out.println(awl.justify(words2, 6));

        String para = "Design a word wrap micro service which provides functionality to take an input string and wraps it so that none of the lines are longer than the max length. The lines should not break any word in the middle.";
        int  maxWidth = 23;

        String words3[] = para.split(" ");
        System.out.println(awl.justify(words3, maxWidth));
    }
}